 ...
 */
public class Quick {
	private static HashMap<String, Integer> documents = null;
    // This class should not be instantiated.
    private Quick() { 
    }
    
    public static void setStandard(HashMap<String, Integer> documents){
    ...
    ***********************************************************************/
    ...
    private static boolean less(String v, String w) {
        return (documents.get(v) > documents.get(w));
    }
